...
───────────────────────────────────────────────────────────────────────────────
 ...
 예시 1 추적
 ─────────
 nums = [2,0,2], queries = [(0,2),(0,2),(1,1)]  // l 기준 정렬
 time=0: available={(0,2),(0,2)} → 두 구간 배정, assigned.size=2==nums[0]
 time=1: nums[1]=0 → 추가 배정 없음
 time=2: nums[2]=2, assigned.size=2 만족
 사용=2, 총=3 ⇒ 버릴 수 1 (queries[2])
